                    ...
                    @endif
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text" style="color: #1b1e21">Criado em: {{ \App\Suporte\Utils::convertDateToString($cliente->created_at) }} -
                                    Atualizado em: {{ \App\Suporte\Utils::convertDateToString($cliente->updated_at) }}</p>
